...
public class RestaurantReservation extends JFrame {
    ...
    private JCheckBox checkBoxSyarat; // Tambahkan variabel JCheckBox
    private String nama;
    ...
    public RestaurantReservation() {
        ...
        // Tambahkan JCheckBox untuk Syarat dan Ketentuan
        checkBoxSyarat = new JCheckBox("Saya menyetujui syarat dan ketentuan");
        checkBoxSyarat.setBounds(50, 220, 250, 20);

        JButton buttonSimpan = new JButton("Simpan");
        buttonSimpan.setBounds(50, 250, 120, 40);
        ...
        panelMenu.add(checkBoxSyarat); // Tambahkan JCheckBox ke panel
        ...
        buttonSimpan.addActionListener(e -> {
            ...
            // Cek apakah pengguna sudah menyetujui syarat dan ketentuan
            if (!checkBoxSyarat.isSelected()) {
                JOptionPane.showMessageDialog(null, "Anda harus menyetujui syarat dan ketentuan!", "Peringatan", JOptionPane.WARNING_MESSAGE);
                return;
            }
