...
public class BiodataLengkap extends JFrame {
    public BiodataLengkap() {
        ...
        // Check box for WNA status, aligned vertically below the radio buttons
        ...
        buttonSimpan.setBounds(50, 240, 100, 40); // Moved to the left (x=50)
    ...
    public static void main(String[] args) {
        javax.swing.SwingUtilities.invokeLater(() -> {
            BiodataLengkap frame = new BiodataLengkap();
